...
OBJ = dechrom.o survey.o plot.o view.o util.o cfa_mask.o write_tiff.o progressbar.o
...
LIBMX= survey.o find.o radial.o plot.o view.o util.o cfa_mask.o write_tiff.o progressbar.o
